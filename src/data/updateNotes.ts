...
export const updateNotes: UpdateEntry[] = [
  {
    ...
    items: [
      ...
      {
        category: 'other',
        text: '退会時に削除されるデータの範囲を広げました。旅程に加えて、現地報告・アズキの記録・スポット投稿も削除されるようになりました。承認済みの車中泊スポットは他の方が地図で利用しているため削除せず、投稿者の情報のみを消して残します。あわせて、ログイン方法ごとにアカウントが分かれていることと、退会操作がログイン方法ごとに必要であることを、プライバシーポリシーと利用規約に明記しました。',
        href: '/privacy',
