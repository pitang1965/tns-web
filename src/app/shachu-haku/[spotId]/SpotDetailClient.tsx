...
import { FieldReportSection } from '@/components/shachu-haku/FieldReportSection';
...
type SpotDetailClientProps = {
  ...
  fieldReports: PublicFieldReport[];
};
...
export default function SpotDetailClient({
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      {/* 現地報告（CONTEXT.md）。
          ここにあった「情報の修正を依頼する」カード（非公開のお問い合わせフォームへの導線）は、
          長期間誰にも使われなかったため削除した。掲載情報との違いも現地報告で受ける。 */}
      <FieldReportSection
        spotId={spot._id}
        spotName={spot.name}
