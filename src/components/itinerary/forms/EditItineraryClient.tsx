...
type EditItineraryClientProps = {
  itineraryPromise: Promise<ClientItineraryDocument | null>;
  id: string;
};

export function EditItineraryClient({
  itineraryPromise,
  id,
}: EditItineraryClientProps) {
  const itinerary = use(itineraryPromise);
