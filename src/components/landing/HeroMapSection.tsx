...
export default function HeroMapSection({
  ...
  if (!MAPBOX_TOKEN) {
    return (
      <div className="h-[50vh] sm:h-[70vh] bg-linear-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800 flex items-center justify-center">
        <div className="text-center px-6">
          <H1 className="mb-4">{buildHeroHeadline(spotCount)}</H1>
