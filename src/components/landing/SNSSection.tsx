    ...
    <section className="py-16 px-6 bg-linear-to-b from-white to-gray-50 dark:from-gray-800 dark:to-gray-900">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          >
            <div className="relative w-20 h-20 shrink-0 rounded-full overflow-hidden border-2 border-gray-200 dark:border-gray-600 group-hover:border-blue-400 dark:group-hover:border-blue-500 transition-colors">
              <Image
                src="/araiazuki.jpg"
                alt="アライアズキ"
                width={80}
