...
// 新規作成用（標高必須）
export const ShachuHakuFormCreateSchema = z
  .object({
  ...
  .superRefine((data, ctx) => {
    ...
    if (
      ...
      ctx.addIssue({
        ...
        message:
          '車中泊場所とトイレの座標が同じです。異なる座標を入力してください',
    ...
    if (
      ...
      ctx.addIssue({
        code: z.ZodIssueCode.custom,
        message:
          '車中泊場所と入浴施設の座標が同じです。異なる座標を入力してください',
        path: ['nearbyBathLat'],
      });
    }
    ...
    if (
      ...
      ctx.addIssue({
        code: z.ZodIssueCode.custom,
        message:
          '車中泊場所とコンビニの座標が同じです。異なる座標を入力してください',
    ...
    if (
      ...
      ctx.addIssue({
        code: z.ZodIssueCode.custom,
        message:
          'トイレと入浴施設の座標が同じです。異なる座標を入力してください',
        path: ['nearbyBathLat'],
      });
    }
    ...
    if (
      ...
      ctx.addIssue({
        code: z.ZodIssueCode.custom,
        message:
          'トイレとコンビニの座標が同じです。異なる座標を入力してください',
        path: ['nearbyConvenienceLat'],
      });
    }
    ...
    if (
      ...
      ctx.addIssue({
        code: z.ZodIssueCode.custom,
        message:
          '入浴施設とコンビニの座標が同じです。異なる座標を入力してください',
        path: ['nearbyConvenienceLat'],
      });
    }
  });
